Accounts.onCreateUser (options, user) ->
  ...
  user.profile.usingTool = {}
  user

randomColor = ->
  # Colors taken from http://www.hitmill.com/html/rgbcolorvalues.html
  colors = ['#FF4848', '#FF68DD', '#FF62B0', '#FE67EB', '#E469FE', '#D568FD', '#9669FE',
            ...
            "#FAFEFB", "#FBFDFB", "#FDFFFD", "#F5FFF2", "#FAFFF7", "#FDFDF0",
            ...
            "#FFFDFD", "#FEFAFB", "#FFFDFF", "#FDFDFF", "#FAFDFE", "#F7FBFA"]
